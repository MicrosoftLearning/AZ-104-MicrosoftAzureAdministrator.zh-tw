...
在這項工作中，您會使用 Azure 入口網站 來產生 Azure Resource Manager 範本。 然後，您可以下載範本，以在未來的部署中使用。 計劃部署數百或數千個磁碟的組織可以利用一或多個範本來協助自動化部署。 
...
1. **從 az104-rg3 - Deployments** 刀鋒視窗中，按兩下部署清單中的第一個專案，並檢閱 [輸入 **] 和 **[範本**] 刀鋒視窗的內容**。
