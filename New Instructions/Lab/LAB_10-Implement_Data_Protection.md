...
1. 在 **[az104-vault1** 復原服務保存庫] 刀鋒視窗的 **[設定]** 區段中，按兩下 **[屬性**]。

1. 在 **az104-vault1 - [屬性]** 刀鋒視窗上，按兩下 **[備份組態 **] 標籤下的 **[更新]** 連結。

1. 在 [**備份組態**] 刀鋒視窗上，檢閱 儲存體 複寫類型的**選擇**。 保留 [異地備援] 的預設設定，並關閉刀鋒視窗。
...
1. 關閉 [**安全性 設定]** 刀鋒視窗，然後回到 **az104-vault1** 復原服務保存庫刀鋒視窗上，按兩下 **[概觀**]。
