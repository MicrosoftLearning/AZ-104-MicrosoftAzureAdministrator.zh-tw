...
，您將檢閱內建角色，並將 VM 參與者角色指派給技術支援中心的成員。 Azure 提供大量的[內建角色](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles)。 
...
在此工作中，您將建立自訂 RBAC 角色。 自訂角色是實作環境最低權限原則的核心部分。 針對您的情節，內建角色可能擁有太多權限。 在此工作中，我們將建立新的角色，並移除不需要的許可權。 您是否有管理重疊權限的計劃？
