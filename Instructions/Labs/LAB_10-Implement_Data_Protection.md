...
1. 選取 [安全性設定] > [虛刪除] 和 [安全性設定 **] 標籤下的 **[**更新**] 連結。
...
1. 按一下 **[確定**] 以建立原則，然後在 [虛擬機器 **] **區段中，選取 [**新增**] （向下捲動）。
...
1. 選取 [下一步：進階設定]。**** 已為您選擇資源。 

1. 向下捲動並 **建立** 自動化帳戶。 

   >**附註：** 填入設定非常重要，否則驗證將會失敗。 
